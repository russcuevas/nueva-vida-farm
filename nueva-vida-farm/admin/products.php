...
?>
        ...
        <!-- View Modal -->
        <div class="modal fade" id="viewProductModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <!-- Settings Modal -->
        <div class="modal fade" id="settingsProductModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <input class="mt-2" type="file" name="product_image" id="modal_product_image_input"
                                accept=".jpg, .jpeg, .png"
                                style="border: 0px solid transparent !important; padding: 0px !important;"
